...
export default function AplazarPartidoModal({ partido, onClose, onSave }) {
    ...
    const fechaFormateada = partido.fecha_partido
        ? partido.fecha_partido.split("T")[0]
        : "";

    // Extraer hora en formato HH:mm (si viene con segundos o zona, ajusta)
    let horaFormateada = "";
    if (partido.hora_partido) {
        // Si viene tipo "22:00:00" o "22:00", tomar solo HH:mm
        horaFormateada = partido.hora_partido.slice(0, 5);
    }

    const [formData, setFormData] = useState({
        fecha_partido: fechaFormateada,
        hora_partido: horaFormateada,
